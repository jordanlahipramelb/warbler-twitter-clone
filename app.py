...
# view function used to log in the user
def do_login(user):
    """Log in user."""
...
# view function used to logout a user
def do_logout():
    """Logout user."""
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        # checks to see of the password if the password for the user using authenticate in User Model
...
def add_like(message_id):
    ...
    # IF THE LIKED MESSAGE'S USER ID IS THE CURRENT USER ID, ABORT
